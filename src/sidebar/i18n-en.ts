...
export const EN: Record<MessageKey, string> = {
  ...
  syncNowHint: "Merge local and remote changes; conflicts must be resolved in the panel below",
  pushHint: "Upload local Cursor settings and ~/.cursor assets to your Gist or repository",
  pullHint: "Download remote changes without deleting files that exist only on this machine",
  exportHint: "One-shot export of settings to a new private Gist (does not replace scheduled sync)",
  importHint: "One-shot import of settings from a private Gist",
  ...
  tabSyncHint: "Sync status, actions, conflicts, and history",
  ...
  nextHint: "Next page",
  conflictsKeepLocalHint: "Keep your local version of this file for the next sync",
  conflictsKeepRemoteHint: "Use the remote version of this file for the next sync",
  conflictsSkipHint: "Leave this file unchanged and skip it in the next sync",
  conflictsApplyAllLocalHint: "Keep local versions for every listed conflict",
  conflictsApplyAllRemoteHint: "Use remote versions for every listed conflict",
  conflictsApplyAllSkipHint: "Skip every listed conflict without overwriting",
  ...
  conflictsResolvedBanner: "Conflicts resolved. Press Sync Now to apply.",
