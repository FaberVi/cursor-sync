...
export type MessageKey =
  ...
  | "openConflictTab"
  | "syncConfirmTitleSyncNow"
  | "syncConfirmTitlePull"
  | "syncConfirmTitleReset"
  | "syncConfirmTitleChatsOnly"
  | "syncConfirmSubtitleSyncNow"
  | "syncConfirmSubtitlePull"
  | "syncConfirmSubtitleReset"
  | "syncConfirmSubtitleChatsOnly"
  | "syncConfirmChipUpdate"
  | "syncConfirmChipDelete"
  | "syncConfirmChipConflict"
  | "syncConfirmChipLocalOnly"
  | "syncConfirmSectionCommits"
  | "syncConfirmSectionIncoming"
  | "syncConfirmSectionLocalOnlyKept"
  | "syncConfirmSectionLocalOnlyDeleted"
  | "syncConfirmSectionConflicts"
  | "syncConfirmWaitingReview"
  | "syncConfirmWaitingConflicts"
  | "resolvedCount"
  | "selectConflictFile";
